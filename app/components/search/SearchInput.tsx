...
export default function SearchInput({
  ...
  const inputErrorStyle =
    "w-[242px] h-[43px] pl-[17px] rounded-[5px] shadow-[0_0_18px_0] shadow-[#0000000D] border-1 mt-[12px] text-red-501 border-red-501";
  const inputStyle =
    "w-[242px] h-[43px] pl-[17px] rounded-[5px] shadow-[0_0_18px_0] shadow-[#0000000D] border-1 border-[#C7C7C7] mt-[12px]";
